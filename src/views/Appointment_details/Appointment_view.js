  ...
  useEffect(() => {
    if (id) {
      const fetchAppointmentById = async () => {
        ...
        const AppointmentJsonResp = await AppointmentResponse.json();
        setAppointment(AppointmentJsonResp);
      };
          ...
          <Grid>
            <Grid item lg={12} xs={12}>
              <Box display="flex" justifyContent="space-between">
                <Typography className="page-heading" variant="h5">View Appointment</Typography>
                                  ...
                                  <TableCell className={[styles.valueCell, 'row-value'].join(' ')}>
                                    {
                                      ...
                                      <Typography variant="body1">
                                        {appointment[key] !== null &&
                                          moment.utc(appointment[key]).format(
